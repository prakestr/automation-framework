...
public class HomePage extends BasePage {
    ...
    public void clickOnRegisterLink() {
        // Locate the register link by class name and click
    ...
    public boolean isLogoutLinkDisplayed() {
        // Locate the logout link and return its display status
        WebElement logoutLink = driver.findElement(By.id("logout-link-id"));
